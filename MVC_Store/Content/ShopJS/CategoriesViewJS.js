$(function () {
    ...
    /*Add new category*/
    var newCatA = $("a#newcata"); /*Link add class*/
    var newCatTextInput = $("#newcatname"); /*Text field class*/
    var ajaxText = $("span.ajax-text"); /*Image upload class*/
    var table = $("table#pages tbody"); /*Table show class*/

    /* func for Enter click (keyCode == 13) */
